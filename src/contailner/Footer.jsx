          ...
          <div className='row'>
            <div className='col-lg-3 col-md-6'>
              ...
              <div className='collapse dont-collapse-sm links' id='collapse_1'>
                <ul>
                  <li>
                    <a href='http://www.ansonika.com/fooyes/about.html'>
                      About us
                    </a>
                  </li>
                  <li>
            ...
            <div className='col-lg-3 col-md-6'>
              ...
              <div className='collapse dont-collapse-sm links' id='collapse_2'>
                <ul>
                  ...
                  <li>
                    <a href='http://www.ansonika.com/fooyes/grid-listing-filterscol-full-masonry.html'>
                      Best Rated
                    </a>
                  </li>
                  <li>
                    <a href='http://www.ansonika.com/fooyes/grid-listing-filterscol-full-width.html'>
                      Best Price
                    </a>
                  </li>
                  <li>
            ...
            <div className='col-lg-3 col-md-6'>
              ...
              <div className='collapse dont-collapse-sm' id='collapse_4'>
                <div id='newsletter'>
                  ...
                  <form
                    method='post'
                    action='assets/newsletter.php.html'
