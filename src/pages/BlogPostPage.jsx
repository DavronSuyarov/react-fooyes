            ...
            <div className='singlepost'>
              ...
              <div className='postmeta'>
                <ul>
                  <li>
                    <a href='#'>
                      <i className='icon_folder-alt' /> Category
                    </a>
                  </li>
                  <li>
                    <i className='icon_calendar' /> 23/12/2015
                  </li>
                  <li>
                    <a href='#'>
                      <i className='icon_pencil-edit' /> Admin
                    </a>
                  </li>
                  <li>
                    <a href='#'>
                      <i className='icon_comment_alt' /> (14) Comments
                    </a>
                  </li>
                </ul>
              </div>
                        ...
                        <li>
                          ...
                          <div className='comment_right clearfix'>
                            ...
                            <p>
                              ...
                              Curabitur vitae mi enim, at vestibulum magna. Cum
                              sociis natoque penatibus et magnis dis parturient
                              montes, nascetur ridiculus mus. Sed sit amet sem a
                              urna rutrumeger fringilla. Nam vel enim ipsum, et
                              congue ante.
                            </p>
                            <p>
                              Aenean iaculis sodales dui, non hendrerit lorem
